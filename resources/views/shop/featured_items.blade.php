                ...
                <div class="card wow zoomInUp" style="visibility: visible; animation-name: zoomInUp;">
                    ...
                    <div class="card-block text-center">
                        ...
                        <a href="javascript:void(0);">
                            ...
                            <img src="{{asset('assets/img/latest/Epelcon Global --latest-1.png')}}" alt=""

                                 class="img-responsive center-block">

                        </a>

                        <h4 class="text-normal text-center">Epelcon Global - Seminars</h4>
                ...
                <div class="card wow zoomInUp" style="visibility: visible; animation-name: zoomInUp;">
                    ...
                    <div class="card-block text-center">
                        ...
                        <a href="javascript:void(0);">
                            ...
                            <img src="{{asset('assets/img/latest/Epelcon Global --latest-2.png')}}" alt=""

                                 class="img-responsive center-block">

                        </a>

                        <h4 class="text-normal text-center">Epelcon Global - Shirts</h4>
                ...
                <div class="card wow zoomInUp" style="visibility: visible; animation-name: zoomInUp;">
                    ...
                    <div class="card-block text-center">
                        ...
                        <a href="javascript:void(0);">
                            ...
                            <img src="{{asset('assets/img/latest/EpelconGlobal--latest-3.png')}}" alt=""
                        ...
                        <p> Learn, Share in the Epelcon Global - Members' Fellowship.</p>
                ...
                <div class="card wow zoomInUp" style="visibility: visible; animation-name: zoomInUp;">
                    ...
                    <div class="card-block text-center">
                        ...
                        <a href="javascript:void(0);">
                            ...
                            <img src="{{asset('assets/img/latest/EpelconGlobal--latest-4.png')}}" alt=""
