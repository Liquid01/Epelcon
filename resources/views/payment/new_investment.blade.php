@extends('layouts.investment_pay')
@section('page_title')
    Make Payment
@endsection
            ...
            <div class="col-md-7 col-md-offset-3">
                ...
                <div class="card card-hero card-primary animated fadeInUp animation-delay-7">
                    ...
                    <div class="card-block">
                        ...
                        <h1 class="color-primary text-center">Investment Payment</h1>
                        <div class="row">
                            <div class="buy_pin">
                                <div class="card">
                                            ...
                                            <div role="buy_pin" aria-controls="buy_pin" role="tab"
                                                ...
                                                <form id="paymentForm" action="javascript:void(0);">
                                                    <div class="form-group">
                                                        <label class="control-label" for="payment_option">How do you
                                                            want to
                                                            pay?</label>
                                                        ...
                                                        <div class="">
                                                            <div class="btn-group bootstrap-select form-control">
                                                                ...
                                                                <select id="payment_option"
                                                                    ...
                                                                    <option value="ussd">USSD Code (GTB, UBA, Zenith,
                                                                        Sterling
                                                                        Only)
                                                                    </option>
                                                                    <option value="ussd">Bank Code (Bank confirmation
                                                                        required)
                                                                    </option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <small class="text-warning">Ensure Phone is correct! - <i
                                                                    class="text-dark" style="color:purple">Notifications
                                                                will be
                                                                sent here.</i></small>
