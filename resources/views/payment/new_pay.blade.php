            ...
            <div class="col-md-7 col-md-offset-3">
                ...
                <div class="card card-hero card-primary animated fadeInUp animation-delay-7">
                    ...
                    <div class="card-block">
                        ...
                        <h1 class="color-primary text-center">Payment</h1>
                                            ...
                                            <div role="buy_pin" aria-controls="buy_pin" role="tab"
                                                ...
                                                <form id="paymentForm" action="javascript:void(0);">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label" for="payment_option">How do you want to
                                                            pay?</label>

                                                        <div class="">
                                                            <div class="btn-group bootstrap-select form-control">

                                                                <select id="payment_option" class="form-control selectpicker"
                                                                        tabindex="-98">
                                                                    <option value="bank_transfer">Bank Transfer</option>
                                                                    <option value="card">Card</option>
                                                                    <option value="ussd">USSD Code (GTB, UBA, Zenith, Sterling Only)
                                                                    </option>
                                                                    <option value="bank">Bank (Bank confirmation (OTP) required)
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label" for="payment_name">Full Name</label>
                                                        <input class="form-control" id="payment_name" type="text" name="payment_name" required>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label" for="payment_amount">Amount</label>
                                                        <input class="form-control" id="payment_amount" type="number" name="payment_amount" required>
                                                    </div>

                                                    <div class="form-group">


                                                        <label class="control-label" for="pay_user_phone">Phone</label>


                                                        <input type="text" id="pay_user_phone" required class="form-control" placeholder="Enter correct Phone number"/>
