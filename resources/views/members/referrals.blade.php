            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0">Referrals</h5>
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item active">All Referrals
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="col s12">
                                <div class="card">
                                    <div class="card-content">
                                        <h4 class="card-title">Length Options</h4>
                                        <div class="row">
                                            <div class="col s12">
                                    ...
                                    <div id="other_account_form">
                                        <form method="post" action="{{route('cash_to_another_account')}}">
                                            ...
                                            <div class="input-field mb-10">
                                                <label for="amount"></label>
                                                <input type="number" min="1" name="amount" required placeholder="amount">
                                                <input type="text" name="recipient" required placeholder="Recipient USERNAME">
