...
<head>
    ...
    <meta name="author" content="epelcon">
    <title>epelcon: Health and Wealth for all.</title>
                ...
                <div class="row">
                    <div class="col col-md-6 col-sm-7 col-12">
                        <div class="contact-intro">
                            <ul>
                                <li><i class="fi flaticon-call"></i>+234 803 604 2328</li>
                                <li><i class="fi flaticon-envelope"></i>info@epelcon.com</li>
                            </ul>
                        </div>
                    </div>
        ...
        <nav class="navigation navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a style="max-width: 100px; padding:0px;
                        margin-top:15px;
                        margin-left:15px;"
                       class="navbar-brand"
                       href="{{url('/')}}">
                ...
                <div id="navbar" class="navbar-collapse collapse navbar-right navigation-holder">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{route('compensation')}}">Success Plan</a></li>
{{--                        <li><a href="{{route('stockists')}}">Stockists</a></li>--}}
                        <li>
                    ...
                    <div class="row">
                        <div class="col col-lg-3 col-md-3 col-sm-6">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <img src="{{asset('assets/images/logo-2.png')}}" alt="blog">
                                </div>
                                <p>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-6">
                            <div class="widget link-widget resource-widget">
                                ...
                                <div class="news-wrap">
                                    <div class="news-img">
                                        <img src="{{asset('assets/images/blog-thumb.png')}}" style="max-width: 80px;" alt="">
                                    </div>
                                    <div class="news-text">
                                        <h3>Health Empowerment Seminars</h3>
                                        <span>All Fridays, 2022</span>
                                    </div>
                                </div>
                                <div class="news-wrap">
                                    <div class="news-img">
                                    ...
                                    <div class="news-text">
                                        <h3>Finance and BUsiness Education</h3>
                                        <span>Saturdays, 2022</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col col-lg-3 col-lg-offset-1 col-md-3 col-sm-6">
                            <div class="widget market-widget wpo-service-link-widget">
                                ...
                                <p>One Stop Shop for all our recurrent health challenges</p>
                                <div class="contact-ft">
                                    <ul>
                                        <li><i class="fi flaticon-pin"></i>No 63/65 Primal Tek Plaza Block B Suit 9 Egbeda-Idimu Road Egbeda Lagos State.</li>
                                        <li><i class="fi flaticon-call"></i>+234 803 604 2328</li>
                                        <li><i class="fi flaticon-envelope"></i>info@epelcon.com</li>
                                    </ul>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-xs-12">
                            <p class="copyright">&copy; 2022 epelcon All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
