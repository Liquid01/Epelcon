...
<head>
    ...
    <title>Epelcon Global - Job Seeds</title>

    <meta name="description" content="epelcon Adertising">
        ...
        <div class="card animated zoomInUp animation-delay-7 color-primary withripple">
            ...
            <div class="card-block">
                ...
                <div class="text-center color-dark">
                    ...
                    <h1 class="color-primary text-big">Jobs</h1>

                    <p class="lead lead-sm">will be open for Employees and Employes in</p>
                    ...
                    <form action="{{route('subscribe_ads')}}" method="post">
                        ...
                        <div class="form-group label-floating mt-2 mb-1">
                            ...
                            <div class="input-group center-block">
                                ...
                                <label class="control-label" for="ms-subscribe">
                                    ...
                                    <i class="zmdi zmdi-email"></i> Stay Notified</label>
...
<script>
    ...
    function makeTimer() {
        ...
        var endTime = new Date("20 Oct 2020 9:56:00 GMT+01:00");
