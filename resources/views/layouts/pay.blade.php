...
<head>
    ...
    <title>Epelcon Glonal Helthcare: @yield('page_title')</title>
    <meta name="keywords"
          content="Epelcon, Epelcon Global, epelcon, Life Seed, epelconglobal Worldwide, Empowerment, Skills Acquisition, Training and Development, Vocational Training, Food, Halthcare, Life Seed Worldwide, MLM, Networking, Food Network ">
    <meta name="description"
          content="epelconglobal Worldwide is a flexible and progressive community of Business Entrepreneurs with the sole mission of eradicatingUnemployment, Poor Nutrition and Healthcare by providing a platform for consistent and affordable  Skills Acquisition, Training and Developing, simplified distribution network of Food Supplies,Charity and Campaign against Hunger and Malnutrition.">
...
<script>
    function payWithPaystack() {
        ...
        switch (payment_option) {
            ...
            case "card":
                var conf = confirm("You have selected " + payment_option.toUpperCase() + " as your payment method, ENTER YOUR CARD DETAILS  on the " +
                    "next Screen and Pay to epelconglobal Worldwide");
                if (conf == false) {
                    return false;
                }
        ...
        var email = "support@epelconglobal.org";
        var phoneNumber = $("#pay_user_phone").val();
        var first = "epelconglobal Worldwide Limited";
//
