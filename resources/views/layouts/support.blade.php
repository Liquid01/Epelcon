...
<head>
    ...
    <meta name="description"
          ...
          content="epelcon is a world of successful entrepreneurs">

    <meta name="keywords"

          content="epelcon: Dashboard">

    {{--<meta name="author" content="ThemeSelect">--}}

    <title>epelcon @yield('page_title') </title>

    <link rel="apple-touch-icon" href="{{asset('assets/img/logos/favicon.png')}}">
                           ...
                           data-target="profile-dropdown">
                            ...
                            @if(app('current_user') != null)
                                ...
                                <span class="hidden"
                                      ...
                                      style="display:none;">{{$pro_pix = app('current_user')->image == null? 'avatar2.png':auth()->user()->image}}</span>
        ...
        <h5 class="logo-wrapper  center-align">
            ...
            <a class="bran-logo darken-1 " href="{{route('dashboard')}}"
               ...
               style="color:orangered; margin-top:20px;line-height:60px; font-size:30px;">
                ...
                <img src="{{asset('assets/img/logos/logo5.png')}}" alt="epelcon" class="img-responsive responsive-img"
...
<div id="main">
    ...
    <div class="row">
        ...
        <div class="col s12 m12 l3">
            ...
            <h5 class="" style="margin-top:75px; color: #666;">Latest Updates</h5>
        ...
        <aside id="right-sidebar-nav">
                                    ...
                                    <span class="avatar-status avatar-online avatar-50"><img
                                       ...
                                       <i></i>
                                        ...
                                        <div class="user-content">
                                            ...
                                            <h6 class="line-height-0">epelcon</h6>
            ...
            <ul id="slide-out-chat" class="sidenav slide-out-right-sidenav-chat right-aligned"
                ...
                <li class="center-align pt-2 pb-2 sidenav-close chat-head">
                    ...
                    <a href="#!"><i class="material-icons mr-0">chevron_left</i>epelcon</a>
    ...
    <div class="footer-copyright">
        ...
        <div class="container">
            ...
            <span>&copy; 2023
                ...
                <a href="{{url('/')}}" target="_blank">epelcon</a> All rights reserved.
