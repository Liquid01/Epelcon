...
@section('content')
    <div class="ms-hero-page ms-hero-img-meeting ms-hero-bg-primary ms-bg-fixed mb-4 mt-4">
        <div class="container">
                    ...
                    <li class="ms-timeline-item wow materialUp">
                        ...
                        <div class="card card-royal">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <img src="assets/img/demo/office1.jpg" alt="" class="img-responsive"> </div>
                                    <div class="col-sm-8">
                        ...
                        <div class="card">
                            <div class="withripple zoom-img">
                                <a href="javascript:void(0);">
                                    <img src="assets/img/demo/m1.jpg" alt="" class="img-responsive"> </a>
                            </div>
